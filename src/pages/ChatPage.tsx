...
const ChatPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Minimal top navbar */}
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 h-16 flex items-center justify-between px-4 shadow-sm fixed top-0 w-full z-10">
        ...
        <div className="flex items-center gap-3">
          <div className="relative max-w-md w-full hidden lg:block">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-2 rounded-full w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
      ...
      <main className="flex-1 pt-16 flex">
        ...
        ${isSidebarCollapsed ? "lg:w-20" : "lg:w-64"}`}>
          <Card className="h-full rounded-none lg:rounded-r-xl shadow-lg border-t-0 border-l-0 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <div className={`p-4 border-b border-gray-200 dark:border-gray-700 ${isSidebarCollapsed ? "lg:p-3" : ""}`}>
        ...
        <div className={`flex-1 p-4 transition-all duration-300 ${isSidebarCollapsed ? "lg:ml-20" : "lg:ml-64"}`}>
          <Card className="h-[calc(100vh-5.5rem)] shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
